...
// Summary of Updates:
// Updated Backend URL: Updated to your backend URL (http://172.31.196.81:5000).

// Fetch Attack Stats: Added the new attack types to the attackStats state and updated the fetchAttackStats function.

// Fetch and Display Analysis Data: Included additional attack types in the attack analysis dropdown and updated the fetchAnalysisData function.

// UI Enhancements: Ensured the layout and design align with your existing theme and components.